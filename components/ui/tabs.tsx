...
const tabsListVariants = cva(
  "group/tabs-list flex items-center rounded-lg p-[3px] text-muted-foreground",
  {
    variants: {
      variant: {
        default: "bg-muted",
